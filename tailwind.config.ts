    ...
    extend: {
      ...
      colors: {
        ...
        aviation: {
          ...
          darker: "hsl(var(--aviation-darker))",
        },
        event: {
          pink: "hsl(var(--event-pink))",
          purple: "hsl(var(--event-purple))",
          "pink-soft": "hsl(var(--event-pink-soft))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      keyframes: {
        ...
        "glowing-fast": {
          ...
          "50%": { opacity: "0.8", filter: "brightness(1.8) contrast(1.2)" },
        },
      },
      animation: {
        ...
        "glowing-fast": "glowing-fast 0.6s ease-in-out infinite",
      },
    },
  },
